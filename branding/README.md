...
- `logo-master.svg` — the full logo (wordmark + mark, or however it's composed). Source for the splash screen and menu logo currently at `app/img/concatcnc-logo.svg` (the old `app/img/OpenBuildsCONTROL.svg`/`openbuilds-logo.svg` were superseded 2026-08-30 and moved to `File13/`).
